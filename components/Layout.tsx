    ...
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="bg-black text-white py-12 border-t-4 border-primary-yellow">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <img src={IMAGES.logo} alt="Logo" className="h-10 mx-auto mb-6 brightness-0 invert" />
          ...
          <div className="text-xs opacity-40 max-w-2xl mx-auto italic mt-8">
            De Ambitie Bar helpt organisaties bij het vinden en binden van medior en senior talent door middel van strategische werving en employer branding.
          </div>
        </div>
      </footer>
    </div>
